...
CREATE TABLE `article`  (
  `aid` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文章编号',
  ...
  `info` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文章内容',
...
CREATE TABLE `article_browse`  (
  ...
  `article_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文章编号',
...
CREATE TABLE `article_category`  (
  ...
  `alias` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '别名',
...
CREATE TABLE `article_comment`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `article_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '评论的文章',
...
CREATE TABLE `article_comment_love`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `index_uid_acid`(`uid`, `ac_id`) USING BTREE
...
CREATE TABLE `dict_group`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '字典类型编号',
  `info` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '组描述',
  `belong` tinyint(4) NOT NULL COMMENT '组隶属于（0： 系统 1：运营）',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `index_dict_group_code`(`code`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '字典组' ROW_FORMAT = Dynamic;
...
CREATE TABLE `dict_item`  (
  ...
  `group_code` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '组编号',
  `name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '配置项名称 key',
  `value` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '业务代码',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL,
  `info` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注信息',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `ids_1`(`group_code`, `name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '字典项' ROW_FORMAT = Dynamic;
...
CREATE TABLE `image_text_group`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `code` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '组编码',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '组名字',
  `purpose` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用途，目的',
  `create_time` datetime(0) NOT NULL,
  `update_time` datetime(0) NOT NULL,
  `status` int(5) NOT NULL DEFAULT 0 COMMENT '状态 1：启动 0：停用',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `index_data_dic_group_code`(`code`) USING BTREE
...
CREATE TABLE `image_text_item`  (
  ...
  `group_code` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '组编码',
  `title` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文字标题',
  `img_url` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图片地址',
  `url` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'javascript:void(0)' COMMENT '链接地址 ',
...
CREATE TABLE `member`  (
  ...
  `fr` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '注册渠道',
  `platform` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '注册平台',
  `ip` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '注册ip',
...
CREATE TABLE `member_article`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NULL DEFAULT NULL COMMENT '收藏用户uid',
  `article_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文章编号',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `index_article_id_uid`(`uid`, `article_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户收藏文章表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `member_info`  (
  ...
  `vip_name` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '普通会员' COMMENT '会员当前vip等级名',
  `growth_value` bigint(20) NOT NULL DEFAULT 0 COMMENT '会员当前成长值',
  `point_value` bigint(20) NULL DEFAULT 0 COMMENT '会员当前积分',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL COMMENT '更新时间',
...
CREATE TABLE `member_message`  (
  ...
  `article_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '消息可能关联的帖子',
...
CREATE TABLE `member_qq`  (
  ...
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `remark` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `uuid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户openID',
  `update_time` datetime(0) NOT NULL COMMENT '授权状态 1：绑定中 2：解绑',
...
CREATE TABLE `member_weibo`  (
  ...
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `remark` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `uuid` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '微博的用户uid',
  `update_time` datetime(0) NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '授权状态 1：绑定中 2：解绑',
  PRIMARY KEY (`uid`) USING BTREE,
  INDEX `xcx_open_id`(`uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_conf`  (
  ...
  `cmd` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '标记',
  ...
  `plan_describe` varchar(512) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '描述',
  `temp` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '模板',
  `aisle` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '通道',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL COMMENT '修改时间',
  `remark` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '备注',
  `temp_content` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `sms_oper`  (
  ...
  `aclass` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '操作类com.xx.oo',
...
CREATE TABLE `sms_record`  (
  ...
  `vcode` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '验证码',
  `status` int(5) NOT NULL DEFAULT 0 COMMENT '0 未使用（未验证） 1：已使用（已验证） 2：已过期',
  `temp_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '短信模板id',
  `temp_content` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '短信模板内容',
  `provider` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '提供商',
  `send_time` datetime(0) NOT NULL COMMENT '发送时间',
  `use_time` datetime(0) NULL DEFAULT NULL COMMENT '使用 时间',
  `expire_time` datetime(0) NOT NULL COMMENT '有效期',
  `remark` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `ids_1`(`mobile`, `temp_id`) USING BTREE,
  INDEX `ids_2`(`status`) USING BTREE,
  INDEX `ids_3`(`expire_time`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_temp`  (
  ...
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '模板标题',
  `content` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '模板内容',
  `create_time` datetime(0) NOT NULL,
  `upadate_time` datetime(0) NOT NULL,
...
CREATE TABLE `sys_role_action`  (
  ...
  `remark` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14379 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_user_cache`  (
  `cache_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'session编号',
...
CREATE TABLE `vip_grade`  (
  ...
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'vip等级名',
  `info` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'vip描述',
  `icon` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'vip icon',
...
CREATE TABLE `vip_grade_task`  (
  ...
  `param` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '参数',
  `remark` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `vip`(`vip`, `vtid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `vip_task`  (
  ...
  `name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'vip升级任务名',
  `info` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'vip升级任务描述',
  `clazz_name` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '可运行类名',
  `param_dec` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '参数说明',
